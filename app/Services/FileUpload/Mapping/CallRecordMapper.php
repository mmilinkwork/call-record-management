...
class CallRecordMapper extends FileMapper
{
    ...
    {
        return [
            'crce_operation' => $this->operation, // crce_operation
            'charge_mode' => $this->feature, // charge_mode
            'sequence_total' => $this->sequenceTotal, // sequence_total
            'imsi' => $this->subscriberImsi, // imsi
            'calling_msisdn' => $this->callingPartyAddress, // calling_msisdn
            'clip_suppress_number' => $this->isCallerIdSuppressed, // clip_suppress_number
            'called_msisdn' => $this->calledPartyAddress, // called_msisdn
            ...
            'apn' => $this->apn, // apn
            'rating_group' => $this->ratingGroupId, // rating_group
            'message_type_indicator' => $this->messageType, // message_type_indicator
            'bearer_type' => $this->bearerType, // bearer_type
            'roaming' => $this->isRoaming, // roaming
            ...
            'answer_time' => $this->answerTimestamp, // answer_time
            'max_call_cost' => $this->maximumCallCost, // max_call_cost
            ...
            'nr_of_segments' => $this->numberOfSegments, // nr_of_segments
            ...
            'charge_free_action' => $this->isChargeFreeAction, // charge_free_action
            'tariff' => $this->tariffId, // tariff
            ...
            'currency' => $this->accountCurrency, // currency
            'closing_balance' => $this->accountClosingBalance, // closing_balance
            'account_type' => $this->accountType, // account_type
            'crce_result_code' => $this->chargingResult, // crce_result_code
