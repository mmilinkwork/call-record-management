...
@section('title', 'Invalid Call Charge Records')

@section('content')

<div class="d-flex justify-content-between align-items-center mb-3">
    <h2>Invalid Call Charge Records</h2>
</div>
...
<div class="card mb-3">
    ...
    <div class="card-body">
        <form method="GET" action="{{ route('call-charge-record-invalids.index') }}" id="filter-form">
            <div class="row g-3 align-items-end">
                ...
                <div class="col-md-4 d-flex gap-2">
                    ...
                    <a href="{{ route('call-charge-record-invalids.index') }}" class="btn btn-outline-secondary">Reset</a>
                    <a href="{{ route('call-charge-record-invalids.export-pdf', array_filter($filters)) }}"
                    ...
                    @forelse ($records as $record)
                        <tr>
                            ...
                            <td class="text-nowrap">
                                <a href="{{ route('call-charge-record-invalids.show', $record) }}" class="btn btn-sm btn-info">Show</a>
                                <a href="{{ route('call-charge-record-invalids.edit', $record) }}" class="btn btn-sm btn-warning">Edit</a>
                                <button type="button"
                                        class="btn btn-sm btn-danger btn-delete"
                                        data-action="{{ route('call-charge-record-invalids.destroy', $record) }}">
                                    Delete
                                </button>
                            </td>
                        </tr>
