...
use App\Http\Controllers\Frontend\CallChargeRecordInvalidController;
...
Route::resource('/call-charge-record-invalids', CallChargeRecordInvalidController::class);
Route::get('/call-charge-record-invalids-export-pdf', [CallChargeRecordInvalidController::class, 'exportPdf'])->name('call-charge-record-invalids.export-pdf');
